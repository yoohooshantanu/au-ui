...
const TEMPLATES = {
	...
	payment_link: {
		...
		formatMessage: (vars: any) => 
			`${vars.name}, your bill of Rs.${vars.amount} for ${vars.startDate} to ${vars.endDate} is due. Pay: https://disha.amarujaladigital.com/dashboard/pay?id=${vars.paymentCycleId} - Amar Ujala`
	}
};
